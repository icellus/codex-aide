...
- When execution roles are active, prefer real subagents when the runtime supports delegation.
...
- `.codex/state/runtime-state.json`: only when runtime automation is active
