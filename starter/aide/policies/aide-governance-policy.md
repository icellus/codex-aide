---
{
  ...
  "runtime_state_path": ".codex/aide/state/governance-context.json",
  "safe_diff_types": ["replace-exact-text", "remove-exact-text", "insert-after-anchor"],
  "special_flow_targets": [".codex/aide/policies/validation-profile.json"],
...
- Maintain active governance items in `.codex/aide/state/governance-context.json`
...
- Targets with dedicated maintenance flows, including `.codex/aide/policies/validation-profile.json`, must bypass generic governance writeback and stay on their special flow
