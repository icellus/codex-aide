...
function hasRuntimeRoot(dirPath) {
  return fs.existsSync(path.join(dirPath, ".codex", "aide"));
}
...
function repoContextPath(projectDir) {
  return path.join(projectDir, ".codex", "aide", "state", "repo-context.json");
}
...
function readCachedRepoRoot(projectDir) {
  ...
  try {
    ...
    if (!hasRuntimeRoot(absoluteCandidate)) {
      return null;
    }
