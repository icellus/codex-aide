...
**Template Target**: `.codex/aide/progress/active/<task-slug>/history/<timestamp>-<slug>.md`
**Archive Target**: `.codex/aide/progress/archive/<task-slug>/history/<timestamp>-<slug>.md`
...
- Current File: `.codex/aide/progress/active/<task-slug>/current.md`
