...
**Template Target**: `.codex/aide/progress/active/<task-slug>/current.md`
**Archive Target**: `.codex/aide/progress/archive/<task-slug>/current.md`
...
**Latest History Entry**: `.codex/aide/progress/active/<task-slug>/history/<timestamp>-<slug>.md`

Use this template for long-running work where release promotion/deploy checkpoints are not the primary concern.
If release checkpoints are primary, use `.codex/aide/templates/progress/release.md` for the same `current.md` target.
...
- History Directory: `.codex/aide/progress/active/<task-slug>/history/`
