...
Source: `discussion/history/2026-03-30-0033-codex-starter-middle-layer-refactor.md`

## 当前状态

本仓库当前只维护 `codex-starter`。

当前主线工作已经从“`story` 一词历史性”切到更大的中层重构：
...
- 把 `任务实施说明` 从 authority / 协议层，落到 runtime 约束层
