...
function runCli(argv = process.argv.slice(2)) {
  ...
  try {
    ...
    process.stderr.write(
      "Usage: node scripts/validate-codex-aide-authority.mjs [--repo-root <path>] [--spec <path>]\n"
    );
    return 2;
  }
  ...
  if (result.errors.length > 0) {
    process.stderr.write("codex-aide authority validation failed:\n");
  ...
  process.stdout.write("codex-aide authority validation passed\n");
  return 0;
}
