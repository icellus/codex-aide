...
function validatorForTarget(relativePath) {
  ...
  if (relativePath === ".codex/policies/routing-policy.md") {
    return {
      kind: "routing-policy",
  ...
  if (relativePath === ".codex/policies/aide-governance-policy.md") {
    return {
  ...
  if (relativePath.startsWith(".codex/skills/") && relativePath.endsWith("/SKILL.md")) {
    return {
      kind: "skill",
  ...
  if (relativePath.startsWith(".codex/agents/") && relativePath.endsWith(".toml")) {
    return {
      kind: "agent",
  ...
  if (relativePath === ".codex/context/project-profile.md") {
    return {
...
async function main(argv = process.argv.slice(2)) {
  ...
  try {
    ...
    process.stderr.write(
      "Usage: node .codex/scripts/guards/validate-governance-target.mjs [--project-dir <path>] --target <path>\n"
    );
    return 2;
  }
